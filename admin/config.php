...
function viewFoot()
{
	...
	($endtime[0]+($endtime[1]-$starttime[1])-$starttime[0])."秒,共执行".$dsql->QueryTimes()."次数据查询</font></td></tr><tr><td align=\"center\"><a target=\"_blank\" href=\"//www.seacms.com/\"><font style=\"font-size:10px;\">POWER BY SEACMS</font></a></td></tr></table></div>";
}
