...
echo '<div class="S_info" style="margin-top:10px;">&nbsp;<img src="img/i3.png" style="width: 12px;height:12px;vertical-align: middle;padding-right: 2px;margin-bottom: 1px;">欢迎访问官方主页获取帮助&nbsp;|&nbsp;<img src="img/rss.gif" style="width: 10px;height:10px;vertical-align: middle;padding-right: 2px;"><a href="//www.seacms.org" target="_blank" >www.seacms.org</a></div>';
echo '</div></div></div>';
viewFoot();
?>
